...
Button minusBtn = {100, ROW_P, BUTTON_WIDTH, BUTTON_HEIGHT, "-"};
Button plusBtn = {100 + BUTTON_WIDTH + BUTTON_SPACING, ROW_P, BUTTON_WIDTH, BUTTON_HEIGHT, "+"};
Button timerMinusBtn = {100, ROW_Y, BUTTON_WIDTH, BUTTON_HEIGHT, "-"};
Button timerPlusBtn = {100 + BUTTON_WIDTH + BUTTON_SPACING, ROW_Y, BUTTON_WIDTH, BUTTON_HEIGHT, "+"};
    ...
    if (lockState) {
        ...
        if (timerRunning) {
            ...
            if (remainingTime > 0) {
                ...
                tft.drawString(timeText, 180, 190, 1);
            } else {
                timerRunning = false;
                tft.drawString("Time's up!", 180, 190, 1);
                greenState = false;
                pumpState = false;
                digitalWrite(LED_RED, LOW);
                analogWrite(pumpPin, 0);
